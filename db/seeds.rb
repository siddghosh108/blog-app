...
first_user = User.create(name: 'Tom',
                         photo: 'https://www.shutterstock.com/image-photo/los-angeles-feb-18-tom-260nw-1649457931.jpg', bio: 'Teacher from Mexico.')
second_user = User.create(name: 'Lilly',
                          photo: 'https://www.hollywoodreporter.com/wp-content/uploads/2022/07/Lily-Singh-The-Bad-Guys-Screening-GettyImages-1391141762-H-2022.jpg', bio: 'YouTuber from America')
...
third_post = Post.create(author: second_user, title: 'Hello 2',
                         text: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.')
fourth_post = Post.create(author: second_user, title: 'Hello 3',
...
Like.create(post: fourth_post, user_id: second_user.id)
Like.create(post: third_post, user_id: second_user.id)
Like.create(post: second_post, user_id: first_user.id)
Like.create(post: fourth_post, user_id: second_user.id)
Like.create(post: fourth_post, user_id: second_user.id)
